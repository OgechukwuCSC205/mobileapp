...
const EntrySectionList: React.FC<Props> = ({ entriesInDateSections }) => {
    ...
    return (
        <SectionList
            style={{ width: '100%', padding: 3, backgroundColor: 'lavender' }}
            ...
            ListHeaderComponent={
                () => (
                    <View>
                        <Text h3 style={[styles.inputContainerStyle, { backgroundColor: "lightpink", justifyContent: "center", textAlign: "center" }]}>To Do List!</Text>
                    </View>
                )}
            ...
            */
            ...
            ItemSeparatorComponent={
                ...
                () => {
                    return (<View style={{ backgroundColor: 'pink', height: 5, width: '100%' }} />)
                }
            }
        />
